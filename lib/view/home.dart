...
class _HomeState extends State<Home> {
  ...
  getNewsofIndia() async {
    String url = "https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=d1975f5992734cb3a4c8455bdefea8a5";
    Response response = await get(Uri.parse(url));
    Map data = jsonDecode(response.body);
    setState(() {
      data["articles"].forEach((element) {
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                  color: Colors.cyan.shade100, borderRadius: BorderRadius.circular(24)),
              child: Row(
                children: [
                  GestureDetector(
                    onTap: () {
            ...
            Container(
              ...
              child: CarouselSlider(
                options: CarouselOptions(
                    height: 170, autoPlay: true, enlargeCenterPage: true),
